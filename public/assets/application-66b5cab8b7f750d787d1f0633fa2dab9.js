...
(function() {
  jQuery(function() {
    $('form').on('click', '.remove_moderator_fields', function(event) {
      $(this).prev('input[type=hidden]').val('1');
      $(this).closest('fieldset').hide();
      return event.preventDefault();
    });
    $('form').on('click', '.add_moderator_fields', function(event) {
      var regexp, time;
    ...
    return $('.debate_dropdown_style').change(function() {
      var debateStyle, newSize;
      ...
      return $('.debate_size_style').val(newSize);
    });
  });
